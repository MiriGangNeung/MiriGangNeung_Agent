...
- **A distant landmark is not a size reference.** A wind turbine, a pavilion, a
  lighthouse or a far ridge is large *and* far away; matching the person to how
  big it looks in frame is what makes the person tower over the landscape. The
  turbine's apparent size tells you nothing about the person's — only the ground
  they stand on and the horizon do.
